...
//AIzaSyDyZS1lXwrSQfLucsqjh2_XrTlm-ZkHjNU
  ...
  static String updatelocationEP = '${baseUrl}updatelocation';
  ...
  static Future postRequest(String url, Map<String, dynamic> body,
    ...
    // String _token;
    String _token = IN.get<AuthStore>().credentialsModel?.data?.apiToken;
    // _token = "z8mmEVl3m0b3b2TeQ20vdXfylTcs74NwvnPlfvPbugK81Qo03PjyVyAhaOT5Bm9tZ5mfKx38ykhfgKOK0wRPIClNkwI6aS1y081R";
